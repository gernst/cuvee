...
(declare-fun %lbl%@1 () Bool)
(declare-fun %lbl%+2 () Bool)
(assert  (and (and (= (type $_Frame@0) (MapType4Type refType boolType)) (= (type $Heap) (MapType1Type refType))) (= (type $Heap@0) (MapType1Type refType))))
(push 1)
(set-info :boogie-vc-id CheckWellformed$$_module.__default.fastexp)
(assert (not
(let ((anon0_correct  (=> (! (and %lbl%+0 true) :lblpos +0) (=> (and (and (and (= $_Frame@0 (|lambda#2| null $Heap alloc false)) (>= |n#0@@5| (LitInt 0))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (and (forall (($o@@13 T@U) ($f@@3 T@U) ) (! (let ((alpha@@10 (FieldTypeInv0 (type $f@@3))))
 (=> (and (and (= (type $o@@13) refType) (= (type $f@@3) (FieldType alpha@@10))) (and (not (= $o@@13 null)) (U_2_bool (MapType1Select $Heap $o@@13 alloc)))) (= (MapType1Select $Heap@0 $o@@13 $f@@3) (MapType1Select $Heap $o@@13 $f@@3))))
 :qid |fastexpb.3159:27|
 :skolemid |511|
 :pattern ( (MapType1Select $Heap@0 $o@@13 $f@@3))
)) ($HeapSucc $Heap $Heap@0)) (and ($IsAlloc (int_2_U |x#0@@7|) TInt $Heap@0) ($IsAlloc (int_2_U |n#0@@5|) TInt $Heap@0)))) (! (or %lbl%@1 (>= |n#0@@5| (LitInt 0))) :lblneg @1)))))
(let ((PreconditionGeneratedEntry_correct  (=> (! (and %lbl%+2 true) :lblpos +2) (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (= 1 $FunctionContextHeight)) anon0_correct))))
PreconditionGeneratedEntry_correct))
))
(check-sat)
(pop 1)
...
(declare-fun $IsHeapAnchor (T@U) Bool)
(assert  (and (= (type $Heap) (MapType1Type refType)) (= (type $_Frame@0) (MapType4Type refType boolType))))
(push 1)
(set-info :boogie-vc-id Impl$$_module.__default.fastexp)
(assert (not
(let ((GeneratedUnifiedExit_correct  (=> (! (and %lbl%+0 true) :lblpos +0) (! (or %lbl%@1 (= |r#0@4| (_module.__default.exp ($LS ($LS $LZ)) |x#0@@7| |n#0@@5|))) :lblneg @1))))
(let ((anon11_Then_correct  (=> (! (and %lbl%+2 true) :lblpos +2) (=> (and (>= 0 |k#0@0|) (= |r#0@4| |r#0@1|)) GeneratedUnifiedExit_correct))))
(let ((anon9_LoopDone_correct  (=> (! (and %lbl%+3 true) :lblpos +3) (=> (and (not true) (= |r#0@4| |r#0@1|)) GeneratedUnifiedExit_correct))))
(let ((anon8_correct  (=> (! (and %lbl%+4 true) :lblpos +4) (and (! (or %lbl%@5  (or (<= 0 |k#0@0|) (= |k#0@3| |k#0@0|))) :lblneg @5) (=> (or (<= 0 |k#0@0|) (= |k#0@3| |k#0@0|)) (and (! (or %lbl%@6 (< |k#0@3| |k#0@0|)) :lblneg @6) (=> (< |k#0@3| |k#0@0|) (=> (and (|_module.__default.exp#canCall| |z#0@2| |k#0@3|) (|_module.__default.exp#canCall| |x#0@@7| |n#0@@5|)) (! (or %lbl%@7  (=> |$w$loop#0@0| (= (Mul |r#0@3| (_module.__default.exp ($LS ($LS $LZ)) |z#0@2| |k#0@3|)) (_module.__default.exp ($LS ($LS $LZ)) |x#0@@7| |n#0@@5|)))) :lblneg @7)))))))))
(let ((anon12_Else_correct  (=> (! (and %lbl%+8 true) :lblpos +8) (=> (and (not (= (Mod |k#0@0| (LitInt 2)) (LitInt 0))) (= |r#0@2| (Mul |r#0@1| |z#0@0|))) (=> (and (and (= |k#0@2| (- |k#0@0| 1)) (= |r#0@3| |r#0@2|)) (and (= |z#0@2| |z#0@0|) (= |k#0@3| |k#0@2|))) anon8_correct)))))
(let ((anon12_Then_correct  (=> (! (and %lbl%+9 true) :lblpos +9) (=> (and (= (Mod |k#0@0| (LitInt 2)) (LitInt 0)) (= |z#0@1| (Mul |z#0@0| |z#0@0|))) (and (! (or %lbl%@10 (not (= (LitInt 2) 0))) :lblneg @10) (=> (not (= (LitInt 2) 0)) (=> (and (and (= |k#0@1| (Div |k#0@0| (LitInt 2))) (= |r#0@3| |r#0@1|)) (and (= |z#0@2| |z#0@1|) (= |k#0@3| |k#0@1|))) anon8_correct)))))))
(let ((anon11_Else_correct  (=> (! (and %lbl%+11 true) :lblpos +11) (=> (> |k#0@0| 0) (and (! (or %lbl%@12 (not (= (LitInt 2) 0))) :lblneg @12) (=> (not (= (LitInt 2) 0)) (and anon12_Then_correct anon12_Else_correct)))))))
(let ((anon10_Else_correct  (=> (! (and %lbl%+13 true) :lblpos +13) (=> |$w$loop#0@0| (and anon11_Then_correct anon11_Else_correct)))))
(let ((anon10_Then_correct  (=> (! (and %lbl%+14 true) :lblpos +14) (=> (not |$w$loop#0@0|) (=> (and ($IsAlloc (int_2_U |z#0@0|) TInt $Heap) ($IsAlloc (int_2_U |k#0@0|) TInt $Heap)) (and (! (or %lbl%@15 (>= |k#0@0| (LitInt 0))) :lblneg @15) (=> (|_module.__default.exp#canCall| |z#0@0| |k#0@0|) (=> (and ($IsAlloc (int_2_U |x#0@@7|) TInt $Heap) ($IsAlloc (int_2_U |n#0@@5|) TInt $Heap)) (! (or %lbl%@16 (>= |n#0@@5| (LitInt 0))) :lblneg @16)))))))))
(let ((anon9_LoopBody_correct  (=> (! (and %lbl%+17 true) :lblpos +17) (and anon10_Then_correct anon10_Else_correct))))
(let ((anon9_LoopHead_correct  (=> (! (and %lbl%+18 true) :lblpos +18) (=> (and (and (and (and (not false) (<= 0 |n#0@@5|)) (=> |$w$loop#0@0| (and (|_module.__default.exp#canCall| |z#0@0| |k#0@0|) (|_module.__default.exp#canCall| |x#0@@7| |n#0@@5|)))) (and (=> |$w$loop#0@0| (= (Mul |r#0@1| (_module.__default.exp ($LS ($LS $LZ)) |z#0@0| |k#0@0|)) (_module.__default.exp ($LS ($LS $LZ)) |x#0@@7| |n#0@@5|))) (forall (($o@@13 T@U) ($f@@3 T@U) ) (! (let ((alpha@@10 (FieldTypeInv0 (type $f@@3))))
 (=> (and (and (= (type $o@@13) refType) (= (type $f@@3) (FieldType alpha@@10))) (and (not (= $o@@13 null)) (U_2_bool (MapType1Select $Heap $o@@13 alloc)))) (= (MapType1Select $Heap $o@@13 $f@@3) (MapType1Select $Heap $o@@13 $f@@3))))
 :qid |fastexpb.3261:37|
 :skolemid |514|
 :pattern ( (MapType1Select $Heap $o@@13 $f@@3))
)))) (and (and ($HeapSucc $Heap $Heap) (forall (($o@@14 T@U) ($f@@4 T@U) ) (! (let ((alpha@@11 (FieldTypeInv0 (type $f@@4))))
 (=> (and (and (= (type $o@@14) refType) (= (type $f@@4) (FieldType alpha@@11))) (and (not (= $o@@14 null)) (U_2_bool (MapType1Select $Heap $o@@14 alloc)))) (or (= (MapType1Select $Heap $o@@14 $f@@4) (MapType1Select $Heap $o@@14 $f@@4)) (U_2_bool (MapType4Select $_Frame@0 $o@@14 $f@@4)))))
 :qid |fastexpb.3266:37|
 :skolemid |515|
 :pattern ( (MapType1Select $Heap $o@@14 $f@@4))
))) (and (<= |k#0@0| |n#0@@5|) (=> (= |k#0@0| |n#0@@5|) true)))) (and anon9_LoopDone_correct anon9_LoopBody_correct)))))
(let ((anon0_correct  (=> (! (and %lbl%+19 true) :lblpos +19) (=> (and (= $_Frame@0 (|lambda#3| null $Heap alloc false)) (= |r#0@0| (LitInt 1))) (and (! (or %lbl%@20  (=> |$w$loop#0@0| (= (Mul |r#0@0| (_module.__default.exp ($LS ($LS $LZ)) |x#0@@7| |n#0@@5|)) (_module.__default.exp ($LS ($LS $LZ)) |x#0@@7| |n#0@@5|)))) :lblneg @20) (=> (=> |$w$loop#0@0| (= (Mul |r#0@0| (_module.__default.exp ($LS ($LS $LZ)) |x#0@@7| |n#0@@5|)) (_module.__default.exp ($LS ($LS $LZ)) |x#0@@7| |n#0@@5|))) anon9_LoopHead_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (! (and %lbl%+21 true) :lblpos +21) (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (= 1 $FunctionContextHeight) (>= |n#0@@5| (LitInt 0)))) anon0_correct))))
PreconditionGeneratedEntry_correct)))))))))))))
))
(check-sat)
