...
case class DefineFun(name: String, formals: List[Var], res: Type, body: Expr, rec: Boolean) extends Cmd

case class DeclareDatatypes(arities: List[(String, Int)], cmds: List[Datatype]) extends Cmd
