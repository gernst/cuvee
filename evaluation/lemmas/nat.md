...
### reduced
    ...
    forall ?ts_ph_nat_0: nat :: (max(?ts_ph_nat_0, ?ts_ph_nat_0) == min(?ts_ph_nat_0, ?ts_ph_nat_0))
    forall ?ts_ph_nat_0: nat :: (leq(?ts_ph_nat_0, ?ts_ph_nat_0) <==> true)
    forall ?ts_ph_nat_0: nat :: (lt(?ts_ph_nat_0, ?ts_ph_nat_0) <==> false)
    forall ?ts_ph_nat_1: nat, ?ts_ph_nat_0: nat :: (leq(succ(?ts_ph_nat_1), ?ts_ph_nat_0) <==> lt(?ts_ph_nat_1, ?ts_ph_nat_0))
    forall ?ts_ph_nat_0: nat, ?ts_ph_nat_1: nat :: (add(?ts_ph_nat_0, succ(?ts_ph_nat_1)) == succ(add(?ts_ph_nat_0, ?ts_ph_nat_1)))
    forall ?ts_ph_nat_0: nat :: (min(succ(?ts_ph_nat_0), ?ts_ph_nat_0) == ?ts_ph_nat_0)
    forall ?ts_ph_nat_0: nat :: (mul(?ts_ph_nat_0, succ(zero)) == ?ts_ph_nat_0)
    forall ?ts_ph_nat_0: nat :: (sub(?ts_ph_nat_0, succ(?ts_ph_nat_0)) == zero)
    forall ?ts_ph_nat_0: nat :: (leq(?ts_ph_nat_0, succ(?ts_ph_nat_0)) <==> true)
    forall ?ts_ph_nat_0: nat :: (max(?ts_ph_nat_0, succ(?ts_ph_nat_0)) == succ(?ts_ph_nat_0))
    forall ?ts_ph_nat_0: nat :: (max(succ(?ts_ph_nat_0), ?ts_ph_nat_0) == succ(?ts_ph_nat_0))
    ...
    forall ?ts_ph_nat_0: nat :: (min(?ts_ph_nat_0, succ(?ts_ph_nat_0)) == min(succ(?ts_ph_nat_0), ?ts_ph_nat_0))
    ...
    forall ?ts_ph_nat_0: nat, ?ts_ph_nat_1: nat :: (min(add(?ts_ph_nat_0, ?ts_ph_nat_1), ?ts_ph_nat_0) == ?ts_ph_nat_0)
    forall ?ts_ph_nat_0: nat, ?ts_ph_nat_1: nat :: (min(?ts_ph_nat_0, add(?ts_ph_nat_0, ?ts_ph_nat_1)) == ?ts_ph_nat_0)
    ...
    forall ?ts_ph_nat_0: nat :: (min(?ts_ph_nat_0, mul(?ts_ph_nat_0, ?ts_ph_nat_0)) == ?ts_ph_nat_0)
    forall ?ts_ph_nat_0: nat :: (sub(?ts_ph_nat_0, mul(?ts_ph_nat_0, ?ts_ph_nat_0)) == zero)
    forall ?ts_ph_nat_0: nat :: (min(mul(?ts_ph_nat_0, ?ts_ph_nat_0), ?ts_ph_nat_0) == min(succ(?ts_ph_nat_0), ?ts_ph_nat_0))
    forall ?ts_ph_nat_0: nat :: (lt(mul(?ts_ph_nat_0, ?ts_ph_nat_0), ?ts_ph_nat_0) <==> leq(succ(?ts_ph_nat_0), ?ts_ph_nat_0))
    forall ?ts_ph_nat_0: nat, ?ts_ph_nat_1: nat :: (max(add(?ts_ph_nat_0, ?ts_ph_nat_1), succ(?ts_ph_nat_0)) == max(succ(?ts_ph_nat_0), add(?ts_ph_nat_0, ?ts_ph_nat_1)))
    forall ?ts_ph_nat_0: nat :: (leq(add(?ts_ph_nat_0, ?ts_ph_nat_0), succ(zero)) <==> leq(?ts_ph_nat_0, zero))
    forall ?ts_ph_nat_0: nat :: (lt(succ(zero), add(?ts_ph_nat_0, ?ts_ph_nat_0)) <==> lt(zero, ?ts_ph_nat_0))
    forall ?ts_ph_nat_0: nat :: (lt(zero, ?ts_ph_nat_0) <==> lt(succ(zero), add(?ts_ph_nat_0, ?ts_ph_nat_0)))
    forall ?ts_ph_nat_0: nat :: (min(succ(zero), ?ts_ph_nat_0) == min(succ(zero), mul(?ts_ph_nat_0, ?ts_ph_nat_0)))
    forall ?ts_ph_nat_0: nat :: (min(succ(zero), add(?ts_ph_nat_0, ?ts_ph_nat_0)) == min(succ(zero), ?ts_ph_nat_0))
    forall ?ts_ph_nat_0: nat :: (leq(add(?ts_ph_nat_0, ?ts_ph_nat_0), succ(?ts_ph_nat_0)) <==> leq(?ts_ph_nat_0, succ(zero)))
    forall ?ts_ph_nat_0: nat :: (leq(?ts_ph_nat_0, succ(zero)) <==> leq(add(?ts_ph_nat_0, ?ts_ph_nat_0), succ(?ts_ph_nat_0)))
    ...
    forall ?ts_ph_nat_0: nat :: (max(mul(?ts_ph_nat_0, ?ts_ph_nat_0), succ(?ts_ph_nat_0)) == max(succ(?ts_ph_nat_0), mul(?ts_ph_nat_0, ?ts_ph_nat_0)))
    forall ?ts_ph_nat_0: nat :: (max(add(?ts_ph_nat_0, ?ts_ph_nat_0), succ(zero)) == max(succ(?ts_ph_nat_0), add(?ts_ph_nat_0, ?ts_ph_nat_0)))
    forall ?ts_ph_nat_0: nat :: (min(succ(?ts_ph_nat_0), add(?ts_ph_nat_0, ?ts_ph_nat_0)) == min(add(?ts_ph_nat_0, ?ts_ph_nat_0), succ(?ts_ph_nat_0)))
    forall ?ts_ph_nat_0: nat :: (sub(succ(zero), add(?ts_ph_nat_0, ?ts_ph_nat_0)) == sub(succ(zero), mul(?ts_ph_nat_0, ?ts_ph_nat_0)))
    forall ?ts_ph_nat_0: nat, ?ts_ph_nat_1: nat :: (lt(?ts_ph_nat_0, ?ts_ph_nat_1) <==> lt(add(?ts_ph_nat_0, ?ts_ph_nat_0), add(?ts_ph_nat_0, ?ts_ph_nat_1)))
    forall ?ts_ph_nat_0: nat, ?ts_ph_nat_1: nat :: (lt(add(?ts_ph_nat_0, ?ts_ph_nat_0), add(?ts_ph_nat_0, ?ts_ph_nat_1)) <==> lt(?ts_ph_nat_0, ?ts_ph_nat_1))
    forall ?ts_ph_nat_0: nat, ?ts_ph_nat_1: nat :: (leq(add(?ts_ph_nat_0, ?ts_ph_nat_1), add(?ts_ph_nat_0, ?ts_ph_nat_0)) <==> leq(?ts_ph_nat_1, ?ts_ph_nat_0))
    forall ?ts_ph_nat_1: nat, ?ts_ph_nat_0: nat :: (leq(?ts_ph_nat_1, ?ts_ph_nat_0) <==> leq(add(?ts_ph_nat_0, ?ts_ph_nat_1), add(?ts_ph_nat_0, ?ts_ph_nat_0)))
    ...
    forall ?ts_ph_nat_0: nat, ?ts_ph_nat_1: nat :: (min(add(?ts_ph_nat_0, ?ts_ph_nat_1), add(?ts_ph_nat_0, ?ts_ph_nat_0)) == add(?ts_ph_nat_0, min(?ts_ph_nat_1, ?ts_ph_nat_0)))
    forall ?ts_ph_nat_0: nat, ?ts_ph_nat_1: nat :: (min(add(?ts_ph_nat_0, ?ts_ph_nat_0), add(?ts_ph_nat_0, ?ts_ph_nat_1)) == add(?ts_ph_nat_0, min(?ts_ph_nat_0, ?ts_ph_nat_1)))
    forall ?ts_ph_nat_0: nat, ?ts_ph_nat_1: nat :: (add(?ts_ph_nat_0, max(?ts_ph_nat_1, ?ts_ph_nat_0)) == max(add(?ts_ph_nat_0, ?ts_ph_nat_1), add(?ts_ph_nat_0, ?ts_ph_nat_0)))
    forall ?ts_ph_nat_0: nat :: (min(mul(?ts_ph_nat_0, ?ts_ph_nat_0), add(?ts_ph_nat_0, ?ts_ph_nat_0)) == min(add(?ts_ph_nat_0, ?ts_ph_nat_0), mul(?ts_ph_nat_0, ?ts_ph_nat_0)))
    forall ?ts_ph_nat_1: nat, ?ts_ph_nat_0: nat :: (max(?ts_ph_nat_1, ?ts_ph_nat_0) == max(?ts_ph_nat_0, ?ts_ph_nat_1))
    forall ?ts_ph_nat_0: nat, ?ts_ph_nat_1: nat :: (min(?ts_ph_nat_0, ?ts_ph_nat_1) == min(?ts_ph_nat_1, ?ts_ph_nat_0))
    forall ?ts_ph_nat_1: nat, ?ts_ph_nat_0: nat :: (add(?ts_ph_nat_1, ?ts_ph_nat_0) == add(?ts_ph_nat_0, ?ts_ph_nat_1))
    forall ?ts_ph_nat_0: nat, ?ts_ph_nat_1: nat :: (leq(?ts_ph_nat_0, ?ts_ph_nat_1) <==> not_(lt(?ts_ph_nat_1, ?ts_ph_nat_0)))
    forall ?ts_ph_nat_1: nat, ?ts_ph_nat_0: nat :: (not_(lt(?ts_ph_nat_1, ?ts_ph_nat_0)) <==> leq(?ts_ph_nat_0, ?ts_ph_nat_1))
    forall ?ts_ph_nat_1: nat, ?ts_ph_nat_0: nat :: (min(?ts_ph_nat_1, max(?ts_ph_nat_0, ?ts_ph_nat_1)) == ?ts_ph_nat_1)
    forall ?ts_ph_nat_0: nat, ?ts_ph_nat_1: nat :: (max(?ts_ph_nat_0, ?ts_ph_nat_1) == max(?ts_ph_nat_1, max(?ts_ph_nat_0, ?ts_ph_nat_1)))
    forall ?ts_ph_nat_1: nat, ?ts_ph_nat_0: nat :: (sub(?ts_ph_nat_1, max(?ts_ph_nat_0, ?ts_ph_nat_1)) == zero)
...
### implied
    ...
    forall ?ts_ph_nat_0: nat :: (min(?ts_ph_nat_0, ?ts_ph_nat_0) == max(?ts_ph_nat_0, ?ts_ph_nat_0))
    forall ?ts_ph_nat_1: nat, ?ts_ph_nat_0: nat :: (lt(?ts_ph_nat_1, ?ts_ph_nat_0) <==> leq(succ(?ts_ph_nat_1), ?ts_ph_nat_0))
    forall ?ts_ph_nat_0: nat, ?ts_ph_nat_1: nat :: (succ(add(?ts_ph_nat_0, ?ts_ph_nat_1)) == add(?ts_ph_nat_0, succ(?ts_ph_nat_1)))
    forall ?ts_ph_nat_0: nat :: (succ(?ts_ph_nat_0) == max(?ts_ph_nat_0, succ(?ts_ph_nat_0)))
    forall ?ts_ph_nat_0: nat :: (succ(?ts_ph_nat_0) == max(succ(?ts_ph_nat_0), ?ts_ph_nat_0))
    forall ?ts_ph_nat_0: nat :: (min(succ(zero), ?ts_ph_nat_0) == min(?ts_ph_nat_0, succ(zero)))
    forall ?ts_ph_nat_0: nat :: (min(succ(?ts_ph_nat_0), ?ts_ph_nat_0) == min(?ts_ph_nat_0, succ(?ts_ph_nat_0)))
    ...
    forall ?ts_ph_nat_0: nat :: (leq(succ(?ts_ph_nat_0), ?ts_ph_nat_0) <==> lt(mul(?ts_ph_nat_0, ?ts_ph_nat_0), ?ts_ph_nat_0))
    forall ?ts_ph_nat_0: nat, ?ts_ph_nat_1: nat :: (max(succ(?ts_ph_nat_0), add(?ts_ph_nat_0, ?ts_ph_nat_1)) == max(add(?ts_ph_nat_0, ?ts_ph_nat_1), succ(?ts_ph_nat_0)))
    forall ?ts_ph_nat_0: nat :: (min(succ(zero), mul(?ts_ph_nat_0, ?ts_ph_nat_0)) == min(succ(zero), ?ts_ph_nat_0))
    forall ?ts_ph_nat_0: nat :: (min(succ(zero), ?ts_ph_nat_0) == min(succ(zero), add(?ts_ph_nat_0, ?ts_ph_nat_0)))
    ...
    forall ?ts_ph_nat_0: nat :: (max(succ(?ts_ph_nat_0), mul(?ts_ph_nat_0, ?ts_ph_nat_0)) == max(mul(?ts_ph_nat_0, ?ts_ph_nat_0), succ(?ts_ph_nat_0)))
    forall ?ts_ph_nat_0: nat :: (max(succ(?ts_ph_nat_0), add(?ts_ph_nat_0, ?ts_ph_nat_0)) == max(add(?ts_ph_nat_0, ?ts_ph_nat_0), succ(zero)))
    forall ?ts_ph_nat_0: nat :: (min(add(?ts_ph_nat_0, ?ts_ph_nat_0), succ(?ts_ph_nat_0)) == min(succ(?ts_ph_nat_0), add(?ts_ph_nat_0, ?ts_ph_nat_0)))
    forall ?ts_ph_nat_0: nat :: (sub(succ(zero), mul(?ts_ph_nat_0, ?ts_ph_nat_0)) == sub(succ(zero), add(?ts_ph_nat_0, ?ts_ph_nat_0)))
    ...
    forall ?ts_ph_nat_0: nat, ?ts_ph_nat_1: nat :: (add(?ts_ph_nat_0, min(?ts_ph_nat_1, ?ts_ph_nat_0)) == min(add(?ts_ph_nat_0, ?ts_ph_nat_1), add(?ts_ph_nat_0, ?ts_ph_nat_0)))
    forall ?ts_ph_nat_0: nat, ?ts_ph_nat_1: nat :: (add(?ts_ph_nat_0, min(?ts_ph_nat_0, ?ts_ph_nat_1)) == min(add(?ts_ph_nat_0, ?ts_ph_nat_0), add(?ts_ph_nat_0, ?ts_ph_nat_1)))
    forall ?ts_ph_nat_0: nat, ?ts_ph_nat_1: nat :: (max(add(?ts_ph_nat_0, ?ts_ph_nat_1), add(?ts_ph_nat_0, ?ts_ph_nat_0)) == add(?ts_ph_nat_0, max(?ts_ph_nat_1, ?ts_ph_nat_0)))
    forall ?ts_ph_nat_0: nat :: (min(add(?ts_ph_nat_0, ?ts_ph_nat_0), mul(?ts_ph_nat_0, ?ts_ph_nat_0)) == min(mul(?ts_ph_nat_0, ?ts_ph_nat_0), add(?ts_ph_nat_0, ?ts_ph_nat_0)))
    forall ?ts_ph_nat_0: nat, ?ts_ph_nat_1: nat :: (max(?ts_ph_nat_0, ?ts_ph_nat_1) == max(?ts_ph_nat_1, ?ts_ph_nat_0))
    forall ?ts_ph_nat_1: nat, ?ts_ph_nat_0: nat :: (min(?ts_ph_nat_1, ?ts_ph_nat_0) == min(?ts_ph_nat_0, ?ts_ph_nat_1))
    forall ?ts_ph_nat_0: nat, ?ts_ph_nat_1: nat :: (add(?ts_ph_nat_0, ?ts_ph_nat_1) == add(?ts_ph_nat_1, ?ts_ph_nat_0))
    forall ?ts_ph_nat_1: nat, ?ts_ph_nat_0: nat :: (max(?ts_ph_nat_1, max(?ts_ph_nat_0, ?ts_ph_nat_1)) == max(?ts_ph_nat_0, ?ts_ph_nat_1))
