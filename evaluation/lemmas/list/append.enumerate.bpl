...
lemma forall y₀: list, y₁: list, x₁: nat :: (snoc(append(y₀, y₁), x₁) == append(y₀, snoc(y₁, x₁)));
...
lemma forall x₀: nat, y₀: list, y₁: nat :: (count(x₀, snoc(y₀, y₁)) == count(add(x₀, zero), cons(y₁, y₀)));
...
lemma forall y₀: list, x₁: list :: (count(length(y₀), x₁) == count(length(y₀), append(x₁, nil)));
lemma forall y₀: list, y₁: list :: (length(append(y₀, y₁)) == add(length(y₀), length(y₁)));
lemma forall y₀: nat, x₁: list :: (count(succ(y₀), x₁) == count(succ(y₀), snoc(x₁, y₀)));
lemma forall y₀: list, y₁: list, x₁: list :: (append(append(y₀, y₁), x₁) == append(append(y₀, y₁), append(x₁, nil)));
lemma forall y₀: list, y₁: list :: (append(y₀, y₁) == append(y₀, append(y₁, nil)));
